...
func (a *Accept) UnmarshalBinary(data []byte) error {
	...
	a.ReplicaId = uint8(*a.pb.ReplicaID)
	a.InstanceId = uint64(*a.pb.InstanceID)
	a.Cmds.FromBytesSlice(a.pb.Cmds)
	a.Deps = a.pb.Deps
	if a.Ballot == nil {
		a.Ballot = new(Ballot)
	}
	a.Ballot.FromProtobuf(a.pb.Ballot)
	a.From = uint8(*a.pb.From)
	return nil
}
